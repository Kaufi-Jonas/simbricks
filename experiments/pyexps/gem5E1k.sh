...
OUT_DIR_SER="$REPO_DIR/experiments/out/gem5Nic/0/gem5-out.server.0"
OUT_DIR_CL="$REPO_DIR/experiments/out/gem5Nic/0/gem5-out.client.0"
OUT_DIR_BASE="$REPO_DIR/experiments/out/gem5Nic/0"
...
X86_ARGS=" --caches --l2cache --l3cache --l1d_size=32kB --l1i_size=32kB --l2_size=2MB --l3_size=32MB --l1d_assoc=8 --l1i_assoc=8 --l2_assoc=4 --l3_assoc=16 --cacheline_size=64 --cpu-clock=3GHz --sys-clock=1GHz --cpu-type=TimingSimpleCPU --mem-size=892MB --num-cpus=1 --ddio-enabled --ddio-way-part=8 --mem-type=DDR4_2400_16x4"
...
DEBUG_FLAGS="Ethernet,DMA,PciDevice"
